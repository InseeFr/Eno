...
/**
 * <p>Classe Java pour footnote complex type.
 * 
 ...
 *         &lt;element name="margin-left" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Footnote {
    ...
    @XmlElement(name = "font-size", defaultValue = "9pt")
    ...
    @XmlElement(name = "margin-left", defaultValue = "3pt")
    ...
    /**
     * Obtient la valeur de la propriété marginLeft.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Définit la valeur de la propriété marginLeft.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
