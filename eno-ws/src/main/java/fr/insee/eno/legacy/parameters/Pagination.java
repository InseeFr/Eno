...
public enum Pagination {
    ...
    public static Pagination fromValue(String v) {
        for (Pagination c: Pagination.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
