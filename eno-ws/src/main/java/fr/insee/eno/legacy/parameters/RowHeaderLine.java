...
/**
 * <p>Classe Java pour row-header-line complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="row-header-line"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "row-header-line", propOrder = {
    "color",
    "fontWeight",
    "fontSize",
    "textAlign"
})
public class RowHeaderLine {
    ...
    @XmlElement(name = "text-align", defaultValue = "center")
