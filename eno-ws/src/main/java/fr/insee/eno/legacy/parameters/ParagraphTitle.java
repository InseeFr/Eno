...
/**
 * <p>Classe Java pour Paragraph-title complex type.
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.
 * 
 * <pre>
 * &lt;complexType name="Paragraph-title"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Paragraph-title", propOrder = {
    "backgroundColor",
    "color",
    "fontWeight",
    "marginBottom",
...
public class ParagraphTitle {
    ...
    @XmlElement(name = "background-color", defaultValue = "#CCCCCC")
    ...
    @XmlElement(name = "font-size", defaultValue = "12pt")
    protected String fontSize;
    @XmlElement(name = "text-align", defaultValue = "left")
    protected String textAlign;
    @XmlElement(name = "space-before", defaultValue = "6mm")
