...
public class PDFStep4EditStructurePagesPostprocessor implements Postprocessor {

	private static final Logger logger = LoggerFactory.getLogger(PDFStep4EditStructurePagesPostprocessor.class);
