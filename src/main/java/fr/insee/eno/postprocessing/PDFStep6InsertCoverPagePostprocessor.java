...
public class PDFStep6InsertCoverPagePostprocessor implements Postprocessor {

	private static final Logger logger = LoggerFactory.getLogger(PDFStep6InsertCoverPagePostprocessor.class);
