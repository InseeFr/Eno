...
public abstract class XFORMSPostProcessor implements Postprocessor  {
	...
	public File process(File input, byte[] parameters, String survey, String styleSheetPath, String extension) throws Exception {
		...
		XslTransformation saxonService = new XslTransformSimplePost(parameters,this.outPostprocessing());
