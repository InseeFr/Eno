...
<xsl:transform version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="deblocage-questionnaire" select="$parameter-file-content//Deblocage/text()='oui'" as="xs:boolean"/>
                        ...
                        <xhtml:p>
                            <xhtml:a href="recapitulatifPdf">Télécharger le récapitulatif de vos
                                réponses au format PDF</xhtml:a>. <xhtml:img
                                    src="{concat('/',$proprietes//images/dossier,'/',$proprietes//images/pdf)}"
                                />
                        </xhtml:p>
                        <xhtml:p>
