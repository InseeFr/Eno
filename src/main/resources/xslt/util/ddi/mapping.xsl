...
<xsl:transform version="2.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    xmlns:s="ddi:studyunit:3_2" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:variable name="end-response-time-question" as="xs:boolean" 
        select="$parameters//fr-parameters/EndQuestion/ResponseTimeQuestion"/>
    <xsl:variable name="end-comment-question" as="xs:boolean" 
        select="$parameters//fr-parameters/EndQuestion/CommentQuestion"/>
