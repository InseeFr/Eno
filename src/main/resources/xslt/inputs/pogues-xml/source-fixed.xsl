...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="pogues:Expression | pogues:Formula | pogues:Response | pogues:Maximum[parent::pogues:Iteration] | pogues:Filter" mode="enopogues:get-ip-id">
    ...
    <xsl:template match="pogues:Expression | pogues:Formula | pogues:Text | pogues:Control/pogues:FailMessage | pogues:Label | pogues:Maximum[parent::pogues:Iteration] | pogues:Filter" mode="enopogues:get-related-variable">
