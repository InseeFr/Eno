...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xf="http://www.w3.org/2002/xforms" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:fr="http://orbeon.org/oxf/xml/form-runner" xmlns:xxf="http://orbeon.org/oxf/xml/xforms" xmlns:ev="http://www.w3.org/2001/xml-events" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xsl:variable name="ArticleServiceProducteur" select="'l'" />
    <xsl:variable name="LibelleServiceProducteur" select="''" />
                        ...
                        <xhtml:div class="frame">
                            ...
                            <xsl:choose>
                                <xsl:when test="$deblocage-questionnaire">
                                    <xhtml:p>
                                        <xhtml:b>Si vous avez terminé de renseigner </xhtml:b>
                                        votre questionnaire, vous pouvez :
                                    </xhtml:p>
                                    <xhtml:p class="indentation-with-bullet">
                                        <xhtml:b> transmettre à nos services&#160;</xhtml:b>
                                        vos réponses en cliquant ci-dessous sur le bouton :
                                    </xhtml:p>
                                </xsl:when>
                                <xsl:otherwise>
                                    <xhtml:p class="indentation-with-bullet">
                                        <xhtml:b>Si vous avez terminé de renseigner&#160;</xhtml:b>
                                        votre questionnaire,
                                        pour le transmettre à nos services, merci de cliquer ci-dessous sur le bouton : "Envoyer".
                                    </xhtml:p>
                                    ...
                                    <xhtml:p class="double-indentation">
                                        ...
                                        <xhtml:b>récapitulatif de vos réponses au format pdf</xhtml:b>
                                        .
                                    </xhtml:p>
                                </xsl:otherwise>
                            </xsl:choose>
                            ...
                            <xsl:choose>
                                <xsl:when test="$deblocage-questionnaire">
                                    ...
                                    <xhtml:p class="indentation-with-bullet">
                                        <xhtml:b> ne pas transmettre le questionnaire et revenir dès à présent </xhtml:b>
                                        sur vos réponses en cliquant sur le bouton : 
                                    ...
                                    <xhtml:p class="simple-identation">
                                        <xsl:text>Dans ce cas-là, vos données seront enregistrées mais</xsl:text>
                                        &#160;
                                        <xhtml:b>
                                            <xsl:text>le questionnaire ne sera pas envoyé à</xsl:text>
                                            &#160;
                                ...
                                <xsl:otherwise>
                                    <xhtml:p class="indentation-with-bullet">
                                        <xhtml:b>Si vous souhaitez y apporter des modifications</xhtml:b>
                                        , vous pouvez :
                                    </xhtml:p>
                                    ...
                                    <xhtml:p class="double-indentation">
                                        <xsl:text>Dans les deux cas, vos données seront enregistrées mais</xsl:text>
                                        &#160;
                                        <xhtml:b>
                                            <xsl:text>le questionnaire ne sera pas
                                                envoyé à </xsl:text>
                                            <xsl:value-of select="$LibelleServiceProducteur" />
                                        </xhtml:b>
                                        .
                        ...
                        <xhtml:div class="frame">
                            ...
                            <xsl:if test="$deblocage-questionnaire">
                                <xf:trigger bind="debloquer-bind" appearance="minimal" class="lienDeblocage">
                                    <xf:label>
                                        <xhtml:p>Souhaitez-vous retourner sur votre questionnaire et compléter votre réponse ?</xhtml:p>
                                    </xf:label>
                                    <xf:action ev:event="DOMActivate">
                            ...
                            <xhtml:p>
                                <xhtml:a href="recapitulatifPdf">Télécharger le récapitulatif de vos
                                    réponses au format PDF</xhtml:a>
                                .
