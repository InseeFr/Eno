...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:enoddi2xforms="http://xml.insee.fr/apps/eno/ddi2form-runner" xmlns:d="ddi:datacollection:3_3"
    ...
    <xsl:import href="../../outputs/xforms/models.xsl" />
    ...
    <xsl:variable name="labels-resource">
        <xsl:sequence select="eno:build-labels-resource($labels-folder,enoxforms:get-form-languages(//d:Sequence[d:TypeOfSequence/text()='template']))" />
    </xsl:variable>
    ...
    <xsl:function name="enoxforms:get-name">
    ...
    <xsl:function name="enoxforms:get-label">
        <xsl:param name="context" as="item()" />
    ...
    <xd:doc>
        <xd:desc>enoxforms:get-label-conditioning-variables</xd:desc>
    </xd:doc>
    <xsl:function name="enoxforms:get-label-conditioning-variables">
        <xsl:param name="context" as="item()" />
        <xsl:param name="language" />
    ...
    <xsl:function name="enoxforms:get-hint">
        <xsl:param name="context" as="item()" />
        <xsl:param name="language" />
        ...
        <xsl:choose>
            ...
            <xsl:when test="not($format-instruction/*)">
                ...
                <xsl:if test="$question-type='question'">
                    ...
                    <xsl:if test="($type='integer' or $type='decimal') and boolean($numeric-example)">
    ...
    <xsl:function name="enoxforms:get-alert">
        <xsl:param name="context" as="item()" />
        <xsl:param name="language" />
    ...
    <xsl:function name="enoxforms:get-form-languages">
        <xsl:param name="context" as="item()" />
        <xsl:choose>
    ...
    <xsl:function name="enoxforms:is-required" as="xs:boolean">
        <xsl:param name="context" as="item()"/>
    ...
    <xsl:function name="enoxforms:get-message-type">
        <xsl:param name="context" as="item()"/>
