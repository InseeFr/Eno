	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 1; i <= 100; i++) {
				...
				outFile = new File(String.format("%s/out" + i + ".pdf", basePathFO2PDF));
		...
		System.out.println(elapsedTime/(60*1000F));
	}
