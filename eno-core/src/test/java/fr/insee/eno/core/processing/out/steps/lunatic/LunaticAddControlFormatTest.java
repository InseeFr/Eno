...
class LunaticAddControlFormatTest {
    ...
    @Test
    @DisplayName("Duration: valid format, no min/max, should not throw exception")
    ...
    @Test
    @DisplayName("Duration: min greater than max, should throw exception")
    void durationMinGreaterThanMax() {
        duration.setFormat(DurationFormat.YEARS_MONTHS);
        duration.setMin("P5Y6M");
    ...
    @Test
    @DisplayName("Duration: entered value less than min, should trigger control error")
    void durationEnteredValueLessThanMin() {
        ...
        String expectedErrorMessage = "\"La durée saisie doit être supérieure à P2Y6M.\"";
    ...
    void durationEnteredValueOutOfBounds() {
        ...
        String expectedErrorMessage = "\"La durée saisie doit être comprise entre P2Y6M et P5Y10M.\"";
