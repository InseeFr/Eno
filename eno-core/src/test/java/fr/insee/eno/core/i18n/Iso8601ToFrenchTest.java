...
class Iso8601ToFrenchTest {
    ...
    void testConvertYearDate_ValidYear() {
        ...
        assertEquals("2023", result.getValue());
    }
    ...
    void testConvertYearDate_InvalidYearLength() {
        ...
        assertEquals("Date '23' is invalid or doesn't match format 'YYYY'.", result.getErrorMessage());
    }
    ...
    void testConvertYearDate_InvalidCharacters() {
        ...
        assertFalse(result.isValid());
        assertEquals("Date 'abcd' is invalid or doesn't match format 'YYYY'.", result.getErrorMessage());
    }
    ...
    void testConvertYearMonthDate_ValidInput() {
        ...
        assertTrue(result.isValid());
        assertEquals("12/2023", result.getValue());
    }
    ...
    void testConvertYearMonthDate_InvalidFormat() {
        DateFormatter.Result result = new Iso8601ToFrench().convertYearMontDate("2023/12");
        assertFalse(result.isValid());
        assertEquals("Date '2023/12' is invalid or doesn't match format 'YYYY-MM'.", result.getErrorMessage());
    }
    ...
    void testConvertYearMonthDate_ExtraCharacters() {
        ...
        assertFalse(result.isValid());
        assertEquals("Date '2023-12-01' is invalid or doesn't match format 'YYYY-MM'.", result.getErrorMessage());
    }
    ...
    void testConvertYearMonthDayDate_ValidInput() {
        ...
        assertTrue(result.isValid());
        assertEquals("16/12/2023", result.getValue());
    }
    ...
    void testConvertYearMonthDayDate_InvalidFormat() {
        DateFormatter.Result result = new Iso8601ToFrench().convertYearMontDayDate("2023/12/16");
        assertFalse(result.isValid());
        assertEquals("Date '2023/12/16' is invalid or doesn't match format 'YYYY-MM-DD'.", result.getErrorMessage());
    }
    ...
    void testConvertYearMonthDayDate_InvalidDate() {
        ...
        assertFalse(result.isValid());
        assertEquals("Date '2023-02-30' is invalid or doesn't match format 'YYYY-MM-DD'.", result.getErrorMessage());
    }
